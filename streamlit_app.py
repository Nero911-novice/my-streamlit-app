...
with tabs[3]:
    ...
    st.markdown("""
    Закон малых чисел - это неформальный термин из психологии и статистики. Люди склонны переоценивать достоверность выводов, сделанных на основе малых выборок. Например, если из 10 клиентов 3 были недовольны, люди могут ошибочно ожидать, что 30% всех клиентов будут недовольны, игнорируя статистическую нестабильность малых выборок.
    """)
