...
tabs = st.tabs(["Закон трёх сигм", "ЦПТ", "ЗБЧ", "Малые выборки","Сравнение распределений","Регрессия к среднему","Проверь свои знания","Типы распределений"])
...
with tabs[7]:
    ...
    # --- Равномерное распределение ---
        ...
        with col2:
            ...
            st.markdown("**Суть:** Все значения в определенном интервале имеют одинаковую вероятность.")
            st.markdown("**Параметры:**")
            st.write(f"- a = {a}")
            st.write(f"- b = {b}")
            st.markdown("**Формула плотности вероятности:**")
    ...
    # --- Биномиальное распределение ---
        ...
        with col2:
            ...
            st.markdown("**Суть:** Описывает количество успехов в фиксированном числе независимых испытания")
            st.markdown("**Параметры:**")
            st.write(f"- n = {n}")
            st.write(f"- p = {p}")
            ...
            st.write("- Количество бракованных изделий в партии")
