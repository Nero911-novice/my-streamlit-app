...
**Примеры**
Представьте результаты теста в классе из 100 учеников со средним баллом 70 и стандартным отклонением 10:
- Примерно 68 учеников получат от 60 до 80 баллов (±1σ)
- Около 95 учеников получат от 50 до 90 баллов (±2σ)
- Почти все 100 учеников получат от 40 до 100 баллов (±3σ)
