...
**Где это используется:** Когда социологи проводят опросы, они опрашивают не всех граждан, а лишь выборку. ЦПТ позволяет им делать обоснованные выводы даже с ограниченными данными.
---  
🔴 **Ограничения**:
...
**Ключевая идея:** Чем больше наблюдений, тем ближе среднее значение к истинному, но мы не можем предсказать, насколько быстро произойдет эта сходимость.
---  
🔴 **Ограничения**:
...
**Частая ошибка:** Люди часто видят причинно-следственную связь там, где её нет: "После того, как мы отругали худших сотрудников, их производительность выросла!" Но это, скорее всего, просто регрессия к среднему, а не результат вмешательства.
---  
🔴 **Ограничения и риски**:
