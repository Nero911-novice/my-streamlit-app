...
with st.sidebar:
    ...
    st.markdown("""
    **Закон трёх сигм**  
    Формула Z-оценки: $Z = \frac{X - \mu}{\sigma}$  
    [Статья на Wikipedia](https://ru.wikipedia.org/wiki/Эмпирическое_правило)
    ...
    **Закон малых чисел**  
    ...
    [Статья на Wikipedia](https://ru.wikipedia.org/wiki/Закон_малых_чисел)
    """, unsafe_allow_html=True)
    st.markdown("""
    **Примеры кода**  
    - `st.slider`, `st.tabs`, `st.download_button`  
    - Встроенные LaTeX-формулы через `st.markdown(..., unsafe_allow_html=True)`  
    """, unsafe_allow_html=True)
